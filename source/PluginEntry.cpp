/**
	...
	`CFFGLPluginInfo` that Wheel.cpp registers at static-initialisation time.
	...
	binary: which build it is.
		...
		strings Wheel.bundle/Contents/MacOS/Wheel | grep wheel
*/

extern "C" const char* WheelBuildStamp()
{
	return "wheel " WHEEL_VERSION " built " __DATE__ " " __TIME__;
}
